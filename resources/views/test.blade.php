...
<!-- Mirrored from lionsbite.co.uk/html/hakduck-preview/shop.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 12 Feb 2020 16:17:50 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="x-ua-compatible" content="ie=edge">
    <title>HakDuck - Shop Full Width</title>
                    ...
                    <div class="col-lg-6">
                        <div class="topbar-right">
                            ...
                            <div class="currency-bar lang-bar pull-right">
                                <ul>
                                    <li><a href="#"><img src="asset/images/icons/gb.png" alt="" />English <i class="fa fa-angle-down"></i></a>
                                        <ul>
        ...
        <div class="sticker header-bottom">
            <div class="container-fluid">
                <div class="row align-items-center">
                    <div class="col-lg-2">
                        <div class="logo">
                            <a href="index-2.html"><img src="asset/images/logo.png" alt="logo" /></a>
                        </div>
                    </div>
                    <div class="col-lg-8">
                        <div class="mainmenu">
                                        ...
                                        <ul>
                                            <li>
                                                <div class="mini-cart-thumb">
                                                    <a href="#"><img src="asset/images/products/cart/thumb-1.jpg" alt="" /></a>
                                                </div>
                                            ...
                                            <li>
                                                <div class="mini-cart-thumb">
                                                    <a href="#"><img src="asset/images/products/cart/thumb-2.jpg" alt="" /></a>
                                                </div>
                                                <div class="mini-cart-heading">
                                                    <span>$460.00 x 1</span>
                                                    <h5><a href="#">Kabino Bedside Table</a></h5>
                                            ...
                                            <div class="row align-items-center m-0">
                                                <div class="col-lg-4 p-0">
                                                    <div class="product-thumb">
                                                        <a href="#"><img src="asset/images/products/latest/1.jpg" alt="" /></a>
                                                    </div>
                                                </div>
                                    ...
                                    <li>
                                        <div class="product-single style-2">
                                            <div class="row align-items-center m-0">
                                                <div class="col-lg-4 p-0">
                                                    <div class="product-thumb">
                                                        <a href="#"><img src="asset/images/products/latest/2.jpg" alt="" /></a>
                                                    </div>
                                                </div>
                                                <div class="col-lg-8 p-0">
                                                    <div class="product-title">
                                    ...
                                    <li>
                                        <div class="product-single style-2">
                                            <div class="row align-items-center m-0">
                                                <div class="col-lg-4 p-0">
                                                    <div class="product-thumb">
                                                        <a href="#"><img src="asset/images/products/latest/3.jpg" alt="" /></a>
                                                    </div>
                                                </div>
                                                <div class="col-lg-8 p-0">
                                                    <div class="product-title">
                    ...
                    <div class="col-lg-5 col-md-12">
                        ...
                        <div class="product-view-system pull-right" role="tablist">
                            <ul class="nav nav-tabs">
                                <li><a class="active" data-toggle="tab" href="#grid-products"><img src="asset/images/icons/icon-grid.png" alt="" /></a></li>
                                <li><a data-toggle="tab" href="#list-products"><img src="asset/images/icons/icon-list.png" alt="" /></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <div id="list-products" class="tab-pane">
                        <div class="product-single wide-style">
                            <div class="row align-items-center">
                                <div class="col-xl-3 col-lg-6 col-md-6">
                                    <div class="product-thumb">
                                        <a href="#"><img src="asset/images/products/shop/16.jpg" alt="" /></a>
                                        <div class="product-quick-view">
                                            <a href="javascript:void(0);" data-toggle="modal" data-target="#quick-view">quick view</a>
                                        </div>
                                    </div>
                        ...
                        <div class="product-single wide-style">
                            <div class="row align-items-center">
                                <div class="col-xl-3 col-lg-6 col-md-6">
                                    <div class="product-thumb">
                                        <a href="#"><img src="asset/images/products/shop/17.jpg" alt="" /></a>
                                        <div class="product-quick-view">
                                            <a href="javascript:void(0);" data-toggle="modal" data-target="#quick-view">quick view</a>
                                        </div>
                                    </div>
                        ...
                        <div class="product-single wide-style">
                            <div class="row align-items-center">
                                <div class="col-xl-3 col-lg-6 col-md-6">
                                    <div class="product-thumb">
                                        <a href="#"><img src="asset/images/products/shop/18.jpg" alt="" /></a>
                                        <div class="product-quick-view">
                                            <a href="javascript:void(0);" data-toggle="modal" data-target="#quick-view">quick view</a>
                                        </div>
                                    </div>
                        ...
                        <div class="product-single wide-style">
                            <div class="row align-items-center">
                                <div class="col-xl-3 col-lg-6 col-md-6">
                                    <div class="product-thumb">
                                        <a href="#"><img src="asset/images/products/shop/19.jpg" alt="" /></a>
                                        <div class="product-quick-view">
                                            <a href="javascript:void(0);" data-toggle="modal" data-target="#quick-view">quick view</a>
                                        </div>
                                    </div>
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="product-single style-2">
                                <div class="row align-items-center">
                                    <div class="col-lg-6 p-0">
                                        <div class="product-thumb">
                                            <a href="#"><img src="asset/images/products/2.jpg" alt="" /></a>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 p-0">
                                        <div class="product-title">
                            ...
                            <div class="product-single style-2">
                                <div class="row align-items-center">
                                    <div class="col-lg-6 p-0">
                                        <div class="product-thumb">
                                            <a href="#"><img src="asset/images/products/4.jpg" alt="" /></a>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 p-0">
                                        <div class="product-title">
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="product-single style-2">
                                <div class="row align-items-center">
                                    <div class="col-lg-6 p-0">
                                        <div class="product-thumb">
                                            <a href="#"><img src="asset/images/products/21.jpg" alt="" /></a>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 p-0">
                                        <div class="product-title">
                            ...
                            <div class="product-single style-2">
                                <div class="row align-items-center">
                                    <div class="col-lg-6 p-0">
                                        <div class="product-thumb">
                                            <a href="#"><img src="asset/images/products/23.jpg" alt="" /></a>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 p-0">
                                        <div class="product-title">
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="product-single style-2">
                                <div class="row align-items-center">
                                    <div class="col-lg-6 p-0">
                                        <div class="product-thumb">
                                            <a href="#"><img src="asset/images/products/9.jpg" alt="" /></a>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 p-0">
                                        <div class="product-title">
                            ...
                            <div class="product-single style-2">
                                <div class="row align-items-center">
                                    <div class="col-lg-6 p-0">
                                        <div class="product-thumb">
                                            <a href="#"><img src="asset/images/products/12.jpg" alt="" /></a>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 p-0">
                                        <div class="product-title">
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="product-single style-2">
                                <div class="row align-items-center">
                                    <div class="col-lg-6 p-0">
                                        <div class="product-thumb">
                                            <a href="#"><img src="asset/images/products/5.jpg" alt="" /></a>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 p-0">
                                        <div class="product-title">
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="product-single style-2">
                                <div class="row align-items-center">
                                    <div class="col-lg-6 p-0">
                                        <div class="product-thumb">
                                            <a href="#"><img src="asset/images/products/6.jpg" alt="" /></a>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 p-0">
                                        <div class="product-title">
            ...
            <div class="col-lg-12">
                <div class="brand-items">
                    <div class="brand-item">
                        <a href="#">
                            <img class="brand-static" src="asset/images/brands/1.jpg" alt="" />
                        </a>
                    </div>
                    <div class="brand-item">
                        <a href="#">
                            <img class="brand-static" src="asset/images/brands/2.jpg" alt="" />
                        </a>
                    </div>
                    <div class="brand-item">
                        <a href="#">
                            <img class="brand-static" src="asset/images/brands/3.jpg" alt="" />
                        </a>
                    </div>
                    <div class="brand-item">
                        <a href="#">
                            <img class="brand-static" src="asset/images/brands/4.jpg" alt="" />
                        </a>
                    </div>
                    <div class="brand-item">
                        <a href="#">
                            <img class="brand-static" src="asset/images/brands/5.jpg" alt="" />
                        </a>
                    </div>
                    <div class="brand-item">
                        <a href="#">
                            <img class="brand-static" src="asset/images/brands/6.jpg" alt="" />
                        </a>
                    </div>
                    <div class="brand-item">
                        <a href="#">
                            <img class="brand-static" src="asset/images/brands/7.jpg" alt="" />
                        </a>
                    </div>
                    <div class="brand-item">
                        <a href="#">
                            <img class="brand-static" src="asset/images/brands/8.jpg" alt="" />
                        </a>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-lg-3 col-sm-6">
                ...
                <div class="payment-gateways">
                    <img src="asset/images/footer/p1.png" alt="" />
                    <img src="asset/images/footer/p2.png" alt="" />
                    <img src="asset/images/footer/p3.png" alt="" />
                    <img src="asset/images/footer/p4.png" alt="" />
                    <img src="asset/images/footer/p5.png" alt="" />
                    <img src="asset/images/footer/p6.png" alt="" />
                </div>
            </div>
                        ...
                        <div class="tab-content">
                            <div id="product-1" class="tab-pane fade in show active">
                                <div class="product-details-thumb">
                                    <img src="asset/images/products/product-details/1.jpg" alt="" />
                                </div>
                            </div>
                            <div id="product-2" class="tab-pane fade">
                                <div class="product-details-thumb">
                                    <img src="asset/images/products/product-details/2.jpg" alt="" />
                                </div>
                            </div>
                            <div id="product-3" class="tab-pane fade">
                                <div class="product-details-thumb">
                                    <img src="asset/images/products/product-details/3.jpg" alt="" />
                                </div>
                            </div>
                        </div>
                        <ul class="nav nav-tabs products-nav-tabs horizontal quick-view mt-10">
                            <li><a class="active" data-toggle="tab" href="#product-1"><img src="asset/images/products/product-details/thumb-1.jpg" alt="" /></a></li>
                            <li><a data-toggle="tab" href="#product-2"><img src="asset/images/products/product-details/thumb-2.jpg" alt="" /></a></li>
                            <li><a data-toggle="tab" href="#product-3"><img src="asset/images/products/product-details/thumb-3.jpg" alt="" /></a></li>
                        </ul>
                    </div>
                    <div class="col-lg-8">
                        <div class="row">
...
<!-- Mirrored from lionsbite.co.uk/html/hakduck-preview/shop.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 12 Feb 2020 16:17:59 GMT -->
</html>
